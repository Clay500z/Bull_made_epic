...
/datum/action/ability/activable/xeno/bull_charge
	...
	desc = "When you hit a host, throw them out of your way while continuing your charge undeterred."
...
/datum/action/ability/activable/xeno/bull_charge/headbutt
	...
	desc = "When you hit a host, stops your charge while headbutting them, knocking them down stunned for some time."
	keybinding_signals = list(
